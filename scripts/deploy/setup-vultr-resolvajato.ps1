...
if (-not $SkipEnv) {
  ...
  $lines = @(
    ...
    "SMTP_PASSWORD=$($kv['SMTP_PASSWORD'])",
    "SMTP_FROM=$($kv['SMTP_FROM'])",
    "SMTP_SSL=$($kv['SMTP_SSL'])",
    "SMTP_START_TLS=$($kv['SMTP_START_TLS'])",
    "QUARKUS_MAILER_HOST=$($kv['QUARKUS_MAILER_HOST'])",
    "QUARKUS_MAILER_PORT=$($kv['QUARKUS_MAILER_PORT'])",
    "QUARKUS_MAILER_USERNAME=$($kv['QUARKUS_MAILER_USERNAME'])",
    "QUARKUS_MAILER_PASSWORD=$($kv['QUARKUS_MAILER_PASSWORD'])",
    "QUARKUS_MAILER_FROM=$($kv['QUARKUS_MAILER_FROM'])",
    "QUARKUS_MAILER_SSL=$($kv['QUARKUS_MAILER_SSL'])",
    "QUARKUS_MAILER_START_TLS=$($kv['QUARKUS_MAILER_START_TLS'])",
